"""Regression checks for the granite-chain-rollup-scope casebook."""
...
from casebook.harness import assert_expected, granite_chain_rollup_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(granite_chain_rollup_scope_summary(), assert_expected())
