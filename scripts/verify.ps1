...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-granite-chain-rollup-detail.ps1
...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-granite-chain-rollup-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-granite-chain-rollup-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-granite_chain_rollup_scope-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
